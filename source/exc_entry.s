...
/* Strong replacement for libnx's weak 1 KiB exception stack. Each of the
 * eight concurrent fault slots receives a separate 64 KiB stack. Defining it
 * in a regular assembly object keeps the symbol's size stable during LTO. */
.section .bss.__nx_exception_stack, "aw", %nobits
.global __nx_exception_stack
.type   __nx_exception_stack, %object
.balign 0x1000
__nx_exception_stack:
    .skip 0x80000
.size __nx_exception_stack, . - __nx_exception_stack
